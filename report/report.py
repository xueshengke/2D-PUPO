...
custom_objects = {'MaskChannel': custom_layers.MaskChannel,
                  ...
                  'PSNR': loss_func.PSNR,
                  'SSIM': loss_func.SSIM,
                  'PSNR_Loss': loss_func.PSNR,
                  'SSIM_Loss': loss_func.SSIM,
                  'cross_domain_mse': loss_func.cross_domain_mse}

if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    parser.add_argument('--model',    default=None, type=str, help='path of Keras model')
    parser.add_argument('--output_dir', default=None, type=str, help='output directory to save report file')
